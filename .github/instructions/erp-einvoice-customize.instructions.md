...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/erp/erp-einvoice-customize.md (v3)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# FBO — Customize e-invoice output
...
Chi tiết: [reference-customize.md](references/erp-einvoice-customize/reference-customize.md)
...
Ví dụ UR: [examples-ur.md](references/erp-einvoice-customize/examples-ur.md)


> Xem thêm: `erp-einvoice-nd70-implement`, `erp-nd252-implement`, `erp-glossary-reference`
