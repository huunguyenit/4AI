...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/erp/erp-view-design.md (v2)
...
Chi tiết pipeline và bảng ánh xạ XML → thẻ HTML: [reference-render-pipeline.md](references/erp-view-design/reference-render-pipeline.md).
...
| File | Nội dung |
|------|----------|
| [reference-item-value.md](references/erp-view-design/reference-item-value.md) | Item columns vs pattern; token; merge/span; entity; `<items>` bẫy trùng tên |
| [reference-view-attrs.md](references/erp-view-design/reference-view-attrs.md) | height (và `&TabHeightFomula;`), anchor, split, categories, categoryIndex |
| [reference-render-pipeline.md](references/erp-view-design/reference-render-pipeline.md) | XML → HTML: thẻ nào ra thẻ nào, cái gì bị bỏ khi render |
