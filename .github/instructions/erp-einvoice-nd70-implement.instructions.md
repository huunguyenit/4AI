...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/erp/erp-einvoice-nd70-implement.md (v1)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# ND70 — Trade discount on e-invoice
...
Chi tiết payload: [reference-payload.md](references/erp-einvoice-nd70-implement/reference-payload.md). Ví dụ HD4: [examples-ur.md](references/erp-einvoice-nd70-implement/examples-ur.md).
...
> Xem thêm: `erp-einvoice-customize`
