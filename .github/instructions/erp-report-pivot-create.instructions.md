...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/erp/erp-report-pivot-create.md (v1)
...
Chi tiết: [reference-pivot.md](references/erp-report-pivot-create/reference-pivot.md).
...
| [reference-pivot.md](references/erp-report-pivot-create/reference-pivot.md) | RS1/RS2, Grid, fill kỳ |
| [examples-pivot.md](references/erp-report-pivot-create/examples-pivot.md) | Ví dụ tham chiếu |


> Xem thêm: `erp-report-create`, `erp-sql-style`
