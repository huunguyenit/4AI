...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/erp/erp-einvoice-package-migrate.md (v3)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# FBO — Update e-invoice runtime package
...
Chi tiết nhóm file: [reference-inventory.md](references/erp-einvoice-package-migrate/reference-inventory.md)
Quy tắc diff/copy: [reference-diff-copy.md](references/erp-einvoice-package-migrate/reference-diff-copy.md)
...
| File | Nội dung |
|------|----------|
| [reference-inventory.md](references/erp-einvoice-package-migrate/reference-inventory.md) | Nhóm path / pattern tên file gói HDDT |
| [reference-diff-copy.md](references/erp-einvoice-package-migrate/reference-diff-copy.md) | Cách diff, bảng báo cáo, lệnh copy an toàn |
