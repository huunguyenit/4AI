...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/erp/erp-category-create.md (v1)
...
- [ ] B3. Validation Dir commands ([check-trung.md](references/erp-category-create/check-trung.md))
- [ ] B4. Database: bảng + PK + structure ([database.md](references/erp-category-create/database.md))
- [ ] B5. Verify MCP
```
...
| File | Nội dung |
|------|----------|
| [xml-structure.md](references/erp-category-create/xml-structure.md) | Dir/Grid, khóa, field types |
| [check-trung.md](references/erp-category-create/check-trung.md) | 3 pattern validation + template SQL |
| [database.md](references/erp-category-create/database.md) | Tạo bảng, PK, MCP |

Ràng buộc nút Grid theo danh mục (realtime): skill `erp-js-implement` -> `js-request-deferred.md`.


> Xem thêm: `erp-controller-reference`, `erp-view-design`, `erp-table-propose`
