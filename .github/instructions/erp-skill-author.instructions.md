...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/erp/erp-skill-author.md (v1)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# FBO — Skill authoring standard
...
Chi tiết + checklist: [reference-patterns.md](references/erp-skill-author/reference-patterns.md)
...
| `erp-report-create` | 3 chiến lược load DATA | `references/erp-skill-author/reference-sql-format.md` của chính nó |
...
| `erp-voucher-data-lookup` | Pipeline CT→CT | `references/erp-skill-author/reference-example-pqadms.md` của chính nó |
