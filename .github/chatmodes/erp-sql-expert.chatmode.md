...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/agents/erp/erp-sql-expert.md (v2)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# FBO backend (SQL) specialist
...
> Xem thêm: `erp-sql-style`, `erp-sql-reference`, `erp-sql-script-location`, `erp-program-config-lookup`, `erp-glossary-reference`, `erp-xml-expert`
