...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/rules/erp/erp-sql-style.md (v4)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# SQL conventions for FBO/FBI code
...
> Xem thêm: `erp-sql-reference`, `erp-report-create`, `erp-sql-access`, `erp-sql-schema-check`
