...
Chi tiết: [reference-item-value.md](references/reference-item-value.md), [reference-view-attrs.md](references/reference-view-attrs.md).
...
| File | Nội dung |
|------|----------|
| [reference-item-value.md](references/reference-item-value.md) | Item columns vs pattern; token; merge/span; entity |
| [reference-view-attrs.md](references/reference-view-attrs.md) | height, anchor, split, categories, categoryIndex |
