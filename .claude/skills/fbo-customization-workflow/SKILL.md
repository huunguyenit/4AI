---
name: fbo-customization-workflow
...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/fbo-xml/fbo-customization-workflow.md (v1)
     Hub: D:\FBO-Shared\mcp\4AI · Regenerate: node tools/4ai.mjs sync -->

# Customization workflow end-to-end
...
> Xem thêm: `fbo-controller-anatomy`, `fbo-f-vs-xml-pairing`, `fbo-entity-resolution-first`
