<!-- GENERATED BY 4AI — DO NOT EDIT.
     Gộp từ 9 asset luôn-nạp. Nguồn: assets/ trong hub.
...
| `pm-ur-analyst` | Sub-agent read-only bóc tài liệu khảo sát/biên bản thành bảng UR draft — map yêu cầu ra controller, chấm độ khó, ước lượng giờ công. Không chốt phạm vi, không sửa file. |
