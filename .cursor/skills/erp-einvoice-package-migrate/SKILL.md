---
name: erp-einvoice-package-migrate
...
Chi tiết nhóm file: [reference-inventory.md](references/reference-inventory.md)
Quy tắc diff/copy: [reference-diff-copy.md](references/reference-diff-copy.md)
...
| File | Nội dung |
|------|----------|
| [reference-inventory.md](references/reference-inventory.md) | Nhóm path / pattern tên file gói HDDT |
| [reference-diff-copy.md](references/reference-diff-copy.md) | Cách diff, bảng báo cáo, lệnh copy an toàn |
