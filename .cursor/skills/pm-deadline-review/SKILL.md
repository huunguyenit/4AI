...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/skills/pm/pm-deadline-review.md (v12)
...
| Cổng PM | `XN` = trong phạm vi và đã chốt hạn; `TA` = chưa chốt hạn / ngoài TLKS chưa có căn cứ; `KL` = vượt FBO — **bắt buộc** `PMReview` nối `BASED_ON` tới `CapabilityVerdict` verdict `khong` (xem [pm-graph-maintain](../pm-graph-maintain/SKILL.md)). Không có thì hỏi PM, không tự kết luận. |
