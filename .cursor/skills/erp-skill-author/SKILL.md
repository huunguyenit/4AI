...
Chi tiết + checklist: [reference-patterns.md](references/reference-patterns.md)
...
| `erp-report-create` | 3 chiến lược load DATA | `references/reference-sql-format.md` của chính nó |
...
| `erp-voucher-data-lookup` | Pipeline CT→CT | `references/reference-example-pqadms.md` của chính nó |
