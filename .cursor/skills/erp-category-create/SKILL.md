...
- [ ] B3. Validation Dir commands ([check-trung.md](references/check-trung.md))
- [ ] B4. Database: bảng + PK + structure ([database.md](references/database.md))
- [ ] B5. Verify MCP
```
...
| File | Nội dung |
|------|----------|
| [xml-structure.md](references/xml-structure.md) | Dir/Grid, khóa, field types |
| [check-trung.md](references/check-trung.md) | 3 pattern validation + template SQL |
| [database.md](references/database.md) | Tạo bảng, PK, MCP |
