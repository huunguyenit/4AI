...
- **A — Tra yêu cầu đã có** ("review yêu cầu trạng thái YC", "UR nào của dự án X còn treo",
  ...
  đó đã qua cổng PM, chỉ còn theo dõi hạn (xem [pm-deadline-review](../skills/pm-deadline-review/SKILL.md)). Đi thẳng bước A, KHÔNG
...
[pm-deadline-review](../skills/pm-deadline-review/SKILL.md) (`node tools/4ai.mjs report`), không làm lại ở đây.
