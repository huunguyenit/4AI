...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/rules/erp/erp-sql-script-location.md (v1)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# SQL scripts live outside the customer program
...
> Xem thêm: `erp-sql-expert`, `erp-deploy-auditor`, `erp-table-propose`
