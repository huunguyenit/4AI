...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/agents/erp/erp-glossary-expert.md (v1)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# Fast ERP glossary (read-only)
...
> Xem thêm: `erp-glossary-reference`, `erp-program-config-lookup`, `erp-sql-reference`, `erp-navigation-lookup`, `erp-mcp-lookup`
