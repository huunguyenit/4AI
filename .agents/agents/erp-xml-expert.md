...
<!-- GENERATED BY 4AI — DO NOT EDIT.
     Source: assets/agents/erp/erp-xml-expert.md (v2)
     Hub: D:\Fast Source\4AI · Regenerate: node tools/4ai.mjs sync -->

# FBO frontend (XML/JS) specialist
...
> Xem thêm: `erp-controller-reference`, `erp-js-implement`, `erp-view-design`, `erp-retrieve-implement`, `erp-builder`, `erp-sql-expert`
