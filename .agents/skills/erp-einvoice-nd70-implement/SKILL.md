---
name: erp-einvoice-nd70-implement
...
Chi tiết payload: [reference-payload.md](references/reference-payload.md). Ví dụ HD4: [examples-ur.md](references/examples-ur.md).
