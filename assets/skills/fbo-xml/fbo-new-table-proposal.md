...
kind: skill
domain: fbo-xml
description: Yêu cầu nhắc tạo bảng hay thêm cột thì soạn gợi ý theo chuẩn FBO — tên bảng zc, chứng từ tham khảo, số hiệu trống, ngưỡng partition. Chỉ gợi ý, không chạy script.
requires: [4ai-fbo]
...
**Làm**: đề xuất tên bảng, chỉ chứng từ chuẩn để sao chép, ghi rõ aspx và controller, đính
mẫu script vào ghi chú UR.
