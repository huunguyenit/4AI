...
requires: [4ai-fbo]
see-also: [4ai-asset-authoring]
version: 1
---
Skill này **bổ sung** `4ai-asset-authoring`, không thay thế. `4ai-asset-authoring` giữ hợp
...
> Hai nguồn mâu thuẫn thì `4ai-asset-authoring` thắng — nó bám sát `schema.mjs`.
...
| `fbo-create-category` | Validation A/B/C | `check-trung.md` |
| `fbo-report` | 3 chiến lược load DATA | `{REFDIR}/reference-sql-format.md` của chính nó |
| `fbo-report` | Filter field@name + proc English | `reference-sql-format.md` |
| `fbo-report-pivot` | RS1/RS2 xoay cột (kế thừa fbo-report) | `reference-pivot.md` |
| `fbo-get-voucher-data` | Pipeline CT→CT | `{REFDIR}/reference-example-pqadms.md` của chính nó |
