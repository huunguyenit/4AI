...
SQL `CheckPqDvumh`: `@@admin` bypass; `vsysuserinfo.id` → `name`; `fsd_StringToTable(@ma_dvcs)`; so khớp danh mục phân quyền. Danh mục: skill [erp-category-create](../erp-category-create/SKILL.md).
