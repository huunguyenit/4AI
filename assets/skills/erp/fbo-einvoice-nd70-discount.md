...
requires: [4ai-fbo]
see-also: [fbo-einvoice-customize]
version: 1
---
...
Skill vá **hóa đơn chiết khấu thương mại** (hóa đơn không lấy dữ liệu hóa đơn gốc): form bảng kê + payload phát hành / điều chỉnh / thay thế. Động cơ A/B/C lấy từ `fbo-einvoice-customize`.
...
CKTM luôn **hai lớp** (master bảng kê + detail tính chất). Pattern A/B/C theo `fbo-einvoice-customize`:
