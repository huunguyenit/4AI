...
**Không dùng** khi: HDDV / ImportXml (`erp-hddv-migrate`); cài proxy; UR chỉ hỏi “sao PH lỗi”.

**Spec NĐ70** (đọc skill đó trước, skill này là động cơ A/B/C): identity / CCCD →
`fbo-einvoice-nd70-identity`; chiết khấu kỳ → `erp-einvoice-nd70-implement`.
