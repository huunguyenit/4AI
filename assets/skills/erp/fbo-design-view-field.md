...
requires: [4ai-fbo]
see-also: [fbo-controller-anatomy, fbo-create-category]
version: 1
---
...
| File | Nội dung |
|------|----------|
| [reference-item-value.md]({REFDIR}/reference-item-value.md) | Item columns vs pattern; token; merge/span; entity |
| [reference-view-attrs.md]({REFDIR}/reference-view-attrs.md) | height, anchor, split, categories, categoryIndex |
