...
severity: hard
always: true
description: Thư mục làm việc đang đứng đã cho biết khách nào — đối chiếu nó với programPath trong data/customers.json trước, chỉ hỏi khi không khớp. Không suy mã khách từ tên thư mục.
