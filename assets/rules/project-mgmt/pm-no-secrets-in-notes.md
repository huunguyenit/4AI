...
kind: rule
domain: project-mgmt
description: Ledger, ADR, changelog, handover không bao giờ chứa connection string, credential hay dữ liệu cá nhân khách — tham chiếu bằng program path và DB alias.
severity: hard
always: true
version: 1
---
